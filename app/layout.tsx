...
export const metadata: Metadata = {
  title: "Stocks Fundamentals | Rules-Based Stock Trade Ideas",
  description:
    "Stocks Fundamentals delivers rules-based stock trade ideas with a dashboard, push notifications, and historical backtests for educational purposes.",
  openGraph: {
